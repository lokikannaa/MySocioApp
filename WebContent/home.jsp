   ...
   <section class="w3-col m7">
    ...
    <section class="w3-col m2">
      <section class="w3-card-2 w3-round w3-white w3-center">
        ...
        <p><img src="uploadfiles/${eachfollowers.picfilepath}" width="25" height="25"/> ${eachfollowers.fullName} @${eachfollowers.nickName}</p>
        ...
        <p><img src="uploadfiles/${eachnonFollowers.picfilepath}" width="25" height="25"/> ${eachnonFollowers.fullName} @${eachnonFollowers.nickName}</p>
        <form action="membershipServlet" method="post">
