...
//    userData = null; 
   try{
      ...
      String sql = "SELECT * FROM socialapp.FOLLOW " + "WHERE followDate >='" +theUserDet.getLastLoginTime() +"' AND followedUserId =" +theUserDet.getUserId();         
...
//    userData = null; 
   try{
      ...
      stmt = conn.createStatement();
       System.out.println("theUserDet.getLastLoginTime() "+theUserDet.getLastLoginTime());
      String sql = "SELECT * FROM socialapp.FOLLOW WHERE UserId =" +theUserDet.getUserId();         
      System.out.println("sql is "+sql);
      rs = stmt.executeQuery(sql);
      SimpleDateFormat formatter = new SimpleDateFormat("E MMM dd HH:mm:ss z yyyy"); 
      while(rs.next())
...
//    userData = null; 
 ...
 //      System.out.println("theUserDet.getLastLoginTime() "+theUserDet.getLastLoginTime());
      ...
      String sql = "INSERT INTO socialapp.Follow (UserId, followedUserId, followDate) VALUES (" +userId +"," +followerId +",'" +followDate +"')";         
      System.out.println("sql is "+sql);
    //  rs = stmt.executeQuery(sql);
...
//    userData = null; 
 ...
 //      System.out.println("theUserDet.getLastLoginTime() "+theUserDet.getLastLoginTime());
      ...
      String sql = "DELETE FROM socialapp.Follow WHERE UserId =" +userId +" AND followedUserId=" +followerId;         
      System.out.println("sql is "+sql);
    //  rs = stmt.executeQuery(sql);
       stmt.executeUpdate(sql);
...
//       return null;   
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT COUNT(*) AS TOTAL FROM socialapp.FOLLOW WHERE UserId =" +curUserId;
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT COUNT(*) AS TOTAL FROM socialapp.FOLLOW WHERE followedUserId =" +curUserId;
