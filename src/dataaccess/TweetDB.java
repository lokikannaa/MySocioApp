...
public class TweetDB {
   ...
   try{
      ...
      {    
      String sql = "INSERT INTO socialapp.TWEET (email, tweet_date, tweet_text, mentionedUser) " + "VALUES ('" + tweet.getEmail() + "'," +
     "'" + tweet.getDate() + "'," +
	 "'" + tweet.getTweet() +"'," +
      ...
      {
            String sql2 = "INSERT INTO socialapp.TWEET (email, tweet_date, tweet_text) " + "VALUES ('" + tweet.getEmail() + "'," +
     "'" + tweet.getDate() + "'," +
	 "'" + tweet.getTweet() + "')" ;
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.TWEET WHERE mentionedUser = '" +userIdNu +"' OR EMAIL = '" +email +"'" ;
...
//       System.out.println("reportDate "+reportDate);
   //   String sql = "SELECT * FROM mytwitter.TWEET WHERE date >= TO_DATE('"  +reportDate +"','E MMM dd HH:mm:ss z yyyy') AND mentionedUser = '" +theUserDet.getUserId()+"'" ;
      String sql = "SELECT * FROM socialapp.TWEET WHERE tweet_date >= '"  +theUserDet.getLastLoginTime() +"' AND mentionedUser = '" +theUserDet.getUserId()+"'" ;
//      "SELECT * FROM mytwitter.USER " + "WHERE EMAIL = '" + emailAddress + "' AND PASSWORD ='" +password +"'";         
...
//           index++; 
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT COUNT(*) AS TOTAL FROM socialapp.TWEET WHERE EMAIL ='" +user.getEmail() +"'";
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sqlm = "delete from socialapp.TWEET  WHERE tweetId = " + tweetid; 
