...
public class UserDB {
   ...
   try{
      ...
      System.out.println("Creating statement...");
                ...
                String s = "INSERT into socialapp.USER (fullName, email, dobDay, dobMonth, dobYear, nickName, passwords, salt,usertype ) VALUES (?,?,?,?,?,?,?,?,?)";
   ...
   System.out.println("Goodbye!");
     ...
     public static void updateLogOutTime(User userLog) {
      ...
      //      System.out.println("password" + password + " " + email);
            //String sql = "UPDATE socialapp.USER SET Last_Login_Time ='" + userLog.getLastLoginTime() + "' WHERE EMAIL ='" + userLog.getEmail() + "'";
//	 + user.getPassword() + "'";
String s = "UPDATE socialapp.USER SET" +"Last_Login_Time = ?"+" where EMAIL= ?";
PreparedStatement ps = (PreparedStatement) conn.prepareStatement(s);
...
//        return userData;
      ...
      public static void updatepass(String email, String password) {
        ...
        try {
            ...
            stmt = conn.createStatement();
            System.out.println("password" + password + " " + email);
            String sql = "UPDATE socialapp.USER SET passwords ='" + password + "' WHERE EMAIL ='" + email + "'";
//	 + user.getPassword() + "'";
...
//        return userData;
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "UPDATE socialapp.USER SET fullName = '" + user.getFullName() + "', dobDay ='" + user.getDobDay() + "', dobMonth ='" 
	 + user.getDobMonth() + "', dobYear ='"
	 + user.getDobYear() + "', passwords ='" 
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      //String sqlm = "UPDATE socialapp.USER SET picfilepath = '" +filepath +"' WHERE email = '" + user.getEmail() + "'"; 
...
//    userData = null; 
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.USER " + "WHERE EMAIL = '" + emailAddress + "' AND passwords ='" +password +"' and usertype <> 'admin'";         
...
//           java.util.Date uDate = formatter.parse(rs.getString("Last_Login_Time").trim()); 
...
//    userData = null; 
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT salt FROM socialapp.USER " + "WHERE EMAIL = '" + email + "'";         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
...
//    userData = null; 
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.USER " + "WHERE NICKNAME = '" + nickName + "'";         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
...
//       return null; 
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.USER where usertype <>'admin' ";         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
...
//    userData = null; 
        try {
            ...
            System.out.println("Creating statement...");
            stmt = conn.createStatement();
            String sql = "SELECT * FROM socialapp.USER " + "WHERE EMAIL = '" + emailAddress + "'";
            System.out.println("sql is " + sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
            rs = stmt.executeQuery(sql);
...
//    userData = null; 
        try {
            ...
            System.out.println("Creating statement...");
            stmt = conn.createStatement();
            String sql = "SELECT * FROM socialapp.USER " + "WHERE userID = " + userIdFollower ;
            System.out.println("sql is " + sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
            rs = stmt.executeQuery(sql);
...
//       return null; 
   ...
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.USER WHERE usertype<>'admin' and userID <>" +logInUser.getUserId();         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
...
//    userData = null; 
   try{
      ...
      System.out.println("Creating statement...");
      stmt = conn.createStatement();
      String sql = "SELECT * FROM socialapp.USER " + "WHERE EMAIL = '" + emailAddress + "' AND passwords ='" +password +"' and usertype <> 'user'";         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
...
//       return null; 
   ...
   try{
      ...
      System.out.println("Connected database successfully...");
      stmt = conn.createStatement();
      String sql = "SELECT userID FROM socialapp.USER " + "WHERE EMAIL = '" +email+"'";         
      System.out.println("sql is "+sql);
//      User userData = stmt.executeUpdate(sql);
//      int resultSet = stmt.executeUpdate(sql);
      rs = stmt.executeQuery(sql);
      ...
      System.out.println("Creating statement...");
      if(i!=0){
          String sqlm = "delete from socialapp.USER  WHERE userID ="+i; 
          
      stmt.executeUpdate(sqlm);
      
      String sqlfollow = "delete from socialapp.Follow  WHERE userID = " + i; 
