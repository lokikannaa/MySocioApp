...
public class UserDB {
	...
	public static void updateLogOutTime(User userLog) {
		...
		try {
			...
			// String sql = "UPDATE socialapp.USER SET Last_Login_Time ='" +
	...
	public static long update(User user) {
		...
		try {
			...
			System.out.println("Creating statement...");
			stmt = conn.createStatement();
			String sql = "UPDATE socialapp.USER SET fullName = '" + user.getFullName() + "', dobDay ='"
	...
	public static void updatepic(User user, String filepath) {
		...
		try {
			...
			System.out.println("Creating statement...");
			stmt = conn.createStatement();
			// String sqlm = "UPDATE socialapp.USER SET picfilepath = '"
	...
	public static User select(String emailAddress, String password) {
		...
		try {
			...
			System.out.println("Creating statement...");
			stmt = conn.createStatement();
			String sql = "SELECT * FROM socialapp.USER " + "WHERE EMAIL = '" + emailAddress + "' AND passwords ='"
	...
	public static ArrayList selectAll() {
		...
		try {
			...
			System.out.println("Creating statement...");
			stmt = conn.createStatement();
			String sql = "SELECT fullName, nickName, email FROM socialapp.USER where usertype <>'admin' ";
			System.out.println("sql is " + sql);
			// User userData = stmt.executeUpdate(sql);
			// int resultSet = stmt.executeUpdate(sql);
			rs = stmt.executeQuery(sql);
